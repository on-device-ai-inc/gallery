...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Can I pay with M-Pesa?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. OnDevice AI accepts M-Pesa in Kenya and Tanzania, MTN MoMo in Ghana, and card payments globally.',
      },
    },
  ],
}
    ...
    <div className="text-slate-700 antialiased selection:bg-cyan-500 selection:text-white min-h-screen pb-24 lg:pb-0">
      ...
      <section className="relative hidden lg:block">
        ...
        <div className="absolute" style={{ top: '100px', left: '72px', maxWidth: '500px' }}>
          ...
          <p className="text-white/45 text-sm mb-10">From {prices.shortLine}</p>
      ...
      {/* MOBILE: image with text overlay, CTAs below */}
      <section className="lg:hidden bg-black">
        <div className="relative">
          ...
          <div className="absolute" style={{ top: '80px', left: '20px', right: '20px' }}>
            ...
            <p className="text-white/40 text-xs">From {prices.shortLine}</p>
          </div>
        </div>
      ...
      {/* ── GEO CITATION — crawlable intro for AI search engines ── */}
      <div className="relative z-10 bg-slate-900 px-6 py-4 text-center">
        <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-4xl mx-auto">
          ...
          It works with or without an internet connection, costs a one-time fee starting at $3.99, and accepts M-Pesa, MTN MoMo,
          and card payments. It runs on phones with as little as 3GB RAM, including Tecno Spark, Infinix Smart, Redmi,
          and Samsung A-series devices.
        </p>
      </div>

      {/* ── SAMUEL PULLQUOTE — social proof right after hero ────── */}
            ...
            {[
              {
                ...
                title: 'For Students',
                body: '"Write essays, summarize lecture notes, and study anywhere — on the bus, between lectures, during a commute. No Wi-Fi needed."',
              },
              {
      ...
      {/* ── 5. SEE WHAT YOU CAN DO — replaces testimonials ────── */}
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className="flex items-start justify-center text-slate-900">
                  ...
                  <span className="text-[5.5rem] leading-none font-black tracking-tighter">{BASE_PRICE_USD.toFixed(2)}</span>
                </div>
                <div className="mt-4 inline-block px-5 py-2.5 rounded-xl border border-slate-200 bg-slate-50">
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.15em] mb-1">Local Equivalents</p>
                  <p className="text-sm text-slate-700 font-semibold">
                    {prices.longLine.split(' · ').map((p, i, arr) => (
                      <span key={i}>{p}{i < arr.length - 1 && <span className="text-slate-400"> · </span>}</span>
                    ))}
                  </p>
                </div>
              ...
              <table className="w-full max-w-3xl mx-auto text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { label: 'Price',        ours: 'From $3.99 one-time', theirs: '$20–$25/month' },
                    ...
                    { label: 'Annual cost',  ours: '$3.99 total', theirs: '$240–$300/year' },
                ...
                <div className="space-y-8">
                  {[
                    ...
                    { q: 'Is there a subscription or hidden charges?',
                      a: `None. You pay ${prices.faqLine} once. No monthly fees, no data charges, no in-app purchases. The AI is yours forever.` },
      ...
      <footer className="relative z-10 bg-white border-t border-slate-200 py-14 px-6 lg:px-12 pb-32 lg:pb-14 mt-8 rounded-t-[2.5rem]">
        <div className="w-full max-w-screen-xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-xs text-slate-400 font-medium mb-6">
            <span className="flex items-center gap-1.5"><ShieldCheck className="w-3 h-3" /> Stripe &amp; M-Pesa Secure Payment</span>
            <span>·</span>
